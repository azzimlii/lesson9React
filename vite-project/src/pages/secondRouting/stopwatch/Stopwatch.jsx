  ...
  return (
    <>
      <div className={css.stopwatch}>
        <div>
        <span className={css.span} onClick={handlerClickHours}>{(state.hours <= 9 ? "0" : "") + state.hours} saat</span>
        <span className={css.span} onClick={handlerClickMinutes}>{(state.minutes <= 9 ? "0" : "") + state.minutes} dq.</span>
        <span className={css.span} onClick={handlerClickSeconds}> {(state.seconds <= 9 ? "0" : "") + state.seconds} sn.</span>
        <hr />
        </div>
